...
fun getCodeForToolbarKey(key: ToolbarKey) = Settings.getInstance().getCustomToolbarKeyCode(key) ?: when (key) {
    ...
    GESTURE_DEEP_SEARCH -> KeyCode.GESTURE_DEEP_SEARCH
...
enum class ToolbarKey {
    ...
    PAGE_UP, PAGE_DOWN, FULL_LEFT, FULL_RIGHT, PAGE_START, PAGE_END, PROOFREAD, TRANSLATE, SELECT_MODE, GESTURE_DEEP_SEARCH,
